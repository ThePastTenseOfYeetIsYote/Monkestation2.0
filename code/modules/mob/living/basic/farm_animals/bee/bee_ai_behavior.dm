/// if we have a hive, this is how far from it we're willing to chase intruders
...
/datum/targeting_strategy/basic/bee/can_attack(mob/living/owner, atom/target, vision_range)
	...
	//if we can still see our hive we won't wander far from it, but if we've been led away we'll keep fighting
...
/datum/pet_command/beehive
	radial_icon = 'icons/obj/hydroponics/equipment.dmi'
