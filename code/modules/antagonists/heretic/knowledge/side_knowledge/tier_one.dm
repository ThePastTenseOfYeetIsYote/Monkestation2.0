...
/datum/heretic_knowledge/void_cloak
	name = "Void Cloak"
	desc = "Fashion a Void Cloak.<br>While the hood is down, acts as a focus. \
		While the hood is up, the cloak is completely invisible, and protects you from space.<br>It also provide decent armor and \
		has pockets which can hold one of your blades, various ritual components (such as organs), and small heretical trinkets.<br>\
		In addition, it never leaves behind fibers."
