...
<<<<<<< HEAD
	weight = 0 //its weight is relative to how much stationary and neglected the nuke disk is. See nuclearbomb.dm. Shouldn't be dynamic hijackable. //monkestation edit: changed to 1 to allow it to always have a slim chance to roll
=======
...
>>>>>>> 7668812d84934cd08e8720312ab242cd5809f313
	max_occurrences = 1
