...
/obj/machinery/vending/access/command/build_access_list(list/inventory)
	...
	inventory[ACCESS_CMO] = list(
		...
		/obj/item/clothing/under/rank/medical/chief_medical_officer/turtleneck/skirt = 1,
		/obj/item/clothing/under/rank/medical/chief_medical_officer/formal = 1,
		/obj/item/clothing/under/rank/medical/chief_medical_officer/formal/skirt = 1,
