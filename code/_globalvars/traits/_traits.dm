...
*/
	...
	/mob = list(
		...
		"TRAIT_STABLE_DWARF" = TRAIT_STABLE_DWARF, // MONKESTATION ADDITION
		"TRAIT_RADHEALING" = TRAIT_RADHEALING, // MONKESTATION ADDITION
		"TRAIT_EMBED_RESISTANCE" = TRAIT_EMBED_RESISTANCE, // MONKESTATION ADDITION
	),
	/obj/item = list(
